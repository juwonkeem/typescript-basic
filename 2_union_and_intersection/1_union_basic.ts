...
//정확인 어떤 element로 구성되어있는 리스트로하려면 타입앞에 union으로 나눠줘야하고
...
//person만 있어도 되고 cat만 있어도 된다. 무언가 하나 충족되면 초과되도 괜찮다 BUT 어떤타입도 충족하지 않은 상태에서 하나씩만 지우면 오류남
